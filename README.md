...
File Triage 是一个用于快速整理杂乱文件夹的开源小工具。它的核心思路很简单：先扫描桌面、下载、iCloud、临时目录等来源文件夹，然后逐个预览文件，再用底部按钮或快捷键把文件移动到目标文件夹、跳过，或移入废纸篓/回收站。
...
- 桌面文件堆太多，需要快速归类。
- 下载目录长期没有整理。
- 图片、PDF、压缩包、截图、临时文件混在一起。
- 想用键盘快速决策，而不是一个个打开 Finder/资源管理器。
